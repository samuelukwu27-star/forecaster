...
class samcodes(ForecastBot):
    ...
    def _llm_config_defaults(self) -> Dict[str, str]:
        ...
        defaults.update({
            ...
            "researcher_search": "openrouter/openrouter/openai/gpt-oss-120b:online",
            "researcher_reasoning": "openrouter/openai/gpt-oss-120b:online",
            "forecaster_gpt": "openrouter/free",
            "forecaster_claude": "openrouter/openrouter/openai/gpt-oss-120b",
